...
@Component({
  selector: 'app-bao-cao-them-khach-hang',
  templateUrl: './bao-cao-them-khach-hang.component.html',
  styleUrls: ['./bao-cao-them-khach-hang.component.css']
})
export class BaoCaoThemKhachHangComponent implements OnInit {
