...
@Component({
  selector: 'app-bao-cao-them-KH-theo-NVKD',
  templateUrl: './bao-cao-them-KH-theo-NVKD.component.html',
  styleUrls: ['./bao-cao-them-KH-theo-NVKD.component.scss']
})
export class BaoCaoThemKHTheoNVKDComponent implements OnInit {
  ...
  GetAllLoi() {
    ...
    this.userService.GetAddKHByNhanVienKDByMonth(model).subscribe((rs: any) => {
      ...
      // title
      this.title = "Thống kê khách hàng của NVKD đã thêm tháng ";
