...
@Component({
  selector: 'app-m-thong-ke-xin-nghi',
  templateUrl: './m-thong-ke-xin-nghi.component.html',
  styleUrls: ['./m-thong-ke-xin-nghi.component.scss']
})
export class MThongKeXinNghiComponent implements OnInit {
